...
namespace DC_Font_Generator
{
    ...
    public class Fnt_char
    {
        ...
        /// <summary>
        /// 釋放 | деструктор, освобождает дату.
        /// </summary>
        ~Fnt_char()
        {
        ...
        {
            get { return this.iBottomAlign; }
            set { this.iBottomAlign = value; }
        }

        public float charViewHeight
        {
            get { return this.icharViewHeight; }
            set { this.icharViewHeight = value; }
        }

        public float charViewWidth
        {
            get { return this.icharViewWidth; }
            set { this.icharViewWidth = value; }
        }

        public float LeftSpace
        {
            get { return this.iLeftSpace; }
            set { this.iLeftSpace = value; }
        }

        public float RightSpace
        {
            get { return this.iRightSpace; }
            set { this.iRightSpace = value; }
        }
